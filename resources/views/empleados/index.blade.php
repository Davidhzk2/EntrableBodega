                        ...
                        <div class="row content-title mb-4">
                            <div class="col-md-4">
                                <div class="show-entries">
                                    <a href="/crear-empleado" class="btn btn-success btnCreate">
                            ...
                            <div class="col-md-4 d-flex justify-content-center align-items-center">
                                <h2>Detalles de <b>Empleados</b></h2>
                            </div>
                            <div class="col-md-4">
                        ...
                        <table class="table table-bordered rounded">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('empleados.detalles', $empleado->id) }}" class="view" title="View" data-toggle="tooltip"><i class="bi bi-eye-fill"></i></a>
