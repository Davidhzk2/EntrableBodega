                        ...
                        <div class="row content-title mb-4">
                            <div class="col-md-4">
                                <div class="show-entries">
                                    <a href="/crear-pedido" class="btn btn-success btnCreate">
                        ...
                        <table class="table table-bordered rounded">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Hora Factura</th>
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    <td>{{$pedido->id}}</td>
                                    <td>{{$pedido->no_factura}}</td>
                                    <td>{{$pedido->fecha_factura}}</td>
                                    <td>{{$pedido->hora_factura}}</td>
                                    <td>{{$pedido->empleado_id}}</td>
                                    <td>{{$pedido->cliente_id}}</td>
                                    <td>{{$pedido->tipo_pago}}</td>
                                    <td>${{$pedido->valor_factura}}</td>
                                    <td>
                                        <a href="{{route('pedidos.detalles', $pedido->id)}}" class="view" title="View" data-toggle="tooltip"><i class="bi bi-eye-fill"></i></a>
                                        <a href="#" class="edit" title="Edit" data-toggle="tooltip"><i class="bi bi-pencil-fill ms-2 me-2"></i></a>
                                        <a href="#" class="delete" title="Delete" data-toggle="tooltip"><i class="bi bi-trash3-fill"></i></a>
                                    </td>
                                </tr>
...
<style>
    ...
    ::-webkit-scrollbar-thumb {
        background-color: #4F0341; /* Color del 'scrollbar' */
