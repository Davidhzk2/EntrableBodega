                        ...
                        <div class="row content-title mb-4">
                            <div class="col-md-4">
                                <div class="show-entries">
                                    <a href="/crear-inventario" class="btn btn-success btnCreate">
                            ...
                            <div class="col-md-4 d-flex justify-content-center align-items-center">
                                <h2>Detalles de <b>Inventarios</b></h2>
                            </div>
                            <div class="col-md-4">
                        ...
                        <table class="table table-bordered rounded">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Cantidad Despacho</th>
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>{{$inventario->cantidad_ingreso}}</td>
                                    <td>{{$inventario->cantidad_despacho}}</td>
                                    <td>{{$inventario->fecha_ingreso}}</td>
                                    <td>{{$inventario->fecha_despacho}}</td>
                                    <td>
                                        <a href="{{route('inventarios.detalles', $inventario->id)}}" class="view" title="View" data-toggle="tooltip"><i class="bi bi-eye-fill"></i></a>
...
<style>
    ...
    table.table tr th, 
    table.table tr td {
        border: 0.2rem solid rgba(97, 109, 133, 0.445);
        color: #002349;
    }
    table.table th i {
        font-size: 13px;
