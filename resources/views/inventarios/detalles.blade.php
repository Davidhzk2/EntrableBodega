...
<body>
            ...
            <div class="col-md-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Detalles Inventario</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <a href="{{ route('inventarios.index') }}" class="btn btn-primary">Volver a la lista de inventarios</a>
</div>
