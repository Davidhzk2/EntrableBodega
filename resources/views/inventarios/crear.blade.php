...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h1 class="mb-5">Registrar inventario</h1>
                    <form class="form" action="{{ route('inventarios.store')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            <label class="mb-2 label-input" for="cantidad_ingreso">Cantidad Ingreso*</label>
                            <input type="number" name="cantidad_ingreso" class="form-control" placeholder="Cantidad de ingreso">
                        </div>
                        <div class="form-group mb-4">
                            <label class="mb-2 label-input" for="cantidad_despacho">Cantidad Despacho*</label>
                            <input type="number" name="cantidad_despacho" class="form-control" placeholder="Cantidad de despacho">
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="mb-2 label-input" for="fecha_ingreso">Fecha Ingreso*</label>
                                    <input type="date" name="fecha_ingreso" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="mb-2 label-input" for="fecha_despacho">Fecha Despacho*</label>
                                    <input type="date" name="fecha_despacho" class="form-control">
                                </div>
                            </div>
                        </div>
                        <p class="subtitle mb-4">Por favor, llenar con los detalles del inventario.</p>
                        <div class="form-group">
